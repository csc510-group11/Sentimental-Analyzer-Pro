...
|Workload is spread over the whole team (one team member is often Xtimes more productive than the others...                                             |3  |[based on additions and deletions of lines on github                                                        ](https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/pulse)   |
|                                                                                                                                                       |     |                                                                                                              |
|Number of commits                                                                                                                                      |3  |    89                                                                                                      |(https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro)
|Number of commits: by different people                                                                                                                 |3  |[in GH                                                                                                     ](https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/graphs/contributors)    |
|Issues reports: there are many                                                                                                                         |3  | [in GH](https://github.com/jayjoshi1400//issue)                                                                                                             |
|Issues are being closed                                                                                                                                |3  |[evidence in GH                                                                                            ](https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/issues?q=is%3Aissue+is%3Aclosed)    |
|DOI badge: exists                                                                                                                                      |3  |https://zenodo.org/records/14226600                                                                                                        |
|Docs: doco generated, format not ugly                                                                                                                  |3    |[in GH                                                                                                  ](https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/blob/master/Software%20Documentation.pdf)       |
...
|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing                          |3  | https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/blob/master/Software%20Documentation.pdf                                                                                                            |
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.                                                |3 |  https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/blob/main/README.md                                                                                                            |
|Use of version control tools                                                                                                                           |3  |   |
|Use of style checkers                                                                                                                                  |3  |[config files in GH showing your this formatter's config                                                     ](https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/actions/workflows/style_checker.yml)  |
|Use of code formatters.                                                                                                                                |3    |[config files iin GH showing this checker's config                                                            ](https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/actions/workflows/code-format.yml) |
|Use of syntax checkers.                                                                                                                                |3  |[config files in GH                                                                                         ](https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/actions/workflows/syntax-checker.yml)   |
|Use of code coverage                                                                                                                                   |3  |[config files in GH                                                                             ](https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/actions/workflows/code_coverage.yml)               |
|Other automated analysis tools                                                                                                                         |3  |https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/actions       |
|Test cases exist                                                                                                                                       |3  |[View Tests](https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/tree/master/sentimental_analysis/realworld/__tests__)                       |
|Test cases are routinely executed                                                                                                                      |3  |  github actions are being used to execute the test cases every time a commit happens. </br> https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/actions/workflows/main.yml                                                                                                            |
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up                               |3  |   https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/blob/master/CONTRIBUTING.md                                                                                                         |
|Issues are discussed before they are closed                                                                                                            |3  |https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/issues/1     |
|Chat channel: exists                                                                                                                                   |3    |    |
|Test cases: a large proportion of the issues related to handling failing cases.                                                                        |  3   |[If a test case fails, open an issue and fix . Also update the existing test cases                                                          ](https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/issues/3)      |
|Evidence that the whole team is using the same tools: everyone can get to all tools and files                                                          |3  |                                                                                                              |
|Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)                              |3  | https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/blob/master/black-master/docs/conf.py </br> https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/blob/master/.pylintrc                                                                                                            |
|Evidence that the whole team is using the same tools (e.g. tutor can ask anyone to share screen, they demonstrate the system running on their computer)|3 |                                                                                                              |
|Evidence that the members of the team are working across multiple places in the code base                                                              |3  |  https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro                                                                                                    |
|Short release cycles                                                                                                                                   |3  | https://github.com/jayjoshi1400/Sentimental-Analyzer-Pro/releases/
