...
from realworld.models import ApiCache

@patch("realworld.decorators.ApiCache.objects.get", side_effect=ApiCache.DoesNotExist)
class ViewsTestCase(TestCase):
    ...
    def test_document_analysis_valid_txt(self, mock_summarize, mock_cache):
    ...
    @patch("realworld.utils.gemini_summarize", return_value="Mock summary")
    def test_text_analysis(self, mock_summarize, mock_cache):
    ...
    def test_image_analysis(self, mock_sentiment, mock_caption, mock_cache):
    ...
    def test_audio_analysis(self, mock_sentiment, mock_transcribe, mock_cache):
    ...
    def test_video_analysis(self, mock_sentiment, mock_video, mock_cache):
    ...
    @patch("realworld.utils.scrape_reviews", return_value=["review1", "review2"])
    @patch("realworld.utils.gemini_sentiment_analysis", return_value={"pos": 0.6, "neg": 0.2, "neu": 0.2})
    def test_book_review(self, mock_sentiment, mock_scrape, mock_cache):
